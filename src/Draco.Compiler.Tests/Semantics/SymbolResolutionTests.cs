...
public sealed class SymbolResolutionTests : SemanticTestsBase
{
    ...
    public void BasicScopeTree()
    {
        ...
        var foo = tree.Root.FindInChildren<ParseNode.Decl.Func>();
        var n = tree.Root.FindInChildren<ParseNode.FuncParam>();
        var x1 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(0);
        var x2 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(1);
        var x3 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(2);
        var x4 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(3);
        var x5 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(4);
        var x6 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(5);
    ...
    public void LocalShadowing()
    {
        ...
        var x0 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(0);
        var x1 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(1);
        var x2 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(2);
        var x3 = tree.Root.FindInChildren<ParseNode.Decl.Variable>(3);

        var x0ref = tree.Root.FindInChildren<ParseNode.Expr.Name>(0);
        var x1ref = tree.Root.FindInChildren<ParseNode.Expr.Name>(1);
        var x2ref = tree.Root.FindInChildren<ParseNode.Expr.Name>(2);
    ...
    public void OrderIndependentReferencing()
    {
        ...
        var barDecl = tree.Root.FindInChildren<ParseNode.Decl.Func>(0);
        var fooDecl = tree.Root.FindInChildren<ParseNode.Decl.Func>(1);
        var bazDecl = tree.Root.FindInChildren<ParseNode.Decl.Func>(2);

        var call1 = tree.Root.FindInChildren<ParseNode.Expr.Call>(0);
        var call2 = tree.Root.FindInChildren<ParseNode.Expr.Call>(1);
        var call3 = tree.Root.FindInChildren<ParseNode.Expr.Call>(2);
    ...
    public void OrderDependentReferencing()
    {
        ...
        var zDecl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(2);

        var xRef = tree.Root.FindInChildren<ParseNode.Expr.Name>(0);
        var zRef = tree.Root.FindInChildren<ParseNode.Expr.Name>(1);
    ...
    public void OrderDependentReferencingWithNesting()
    {
        ...
        var x1Decl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(0);
        var y1Decl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(1);
        var z1Decl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(2);
        var x2Decl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(3);
        var k1Decl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(4);
        var w1Decl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(5);
        var k2Decl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(6);

        var x1Ref1 = tree.Root.FindInChildren<ParseNode.Expr.Name>(0);
        var y1Ref1 = tree.Root.FindInChildren<ParseNode.Expr.Name>(1);
        var x2Ref1 = tree.Root.FindInChildren<ParseNode.Expr.Name>(2);
        var wRefErr1 = tree.Root.FindInChildren<ParseNode.Expr.Name>(3);
        var wRefErr2 = tree.Root.FindInChildren<ParseNode.Expr.Name>(4);
    ...
    public void ParameterRedefinitionError()
    {
        ...
        var x1Decl = tree.Root.FindInChildren<ParseNode.FuncParam>(0);
        var x2Decl = tree.Root.FindInChildren<ParseNode.FuncParam>(1);
    ...
    public void FuncOverloadsGlobalVar()
    {
        ...
        var varDecl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(0);
        var funcDecl = tree.Root.FindInChildren<ParseNode.Decl.Func>(0);
    ...
    public void GlobalVariableDefinedLater()
    {
        ...
        var localVarDecl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(0);
        var globalVarDecl = tree.Root.FindInChildren<ParseNode.Decl.Variable>(1);
