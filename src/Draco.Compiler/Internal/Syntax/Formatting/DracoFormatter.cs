...
internal sealed class DracoFormatter : Api.Syntax.SyntaxVisitor
{
    ...
    {
        TokenKind.KeywordAnd => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordElse => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordFor => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordGoto => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordImport => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordIn => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordInternal => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordModule => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordOr => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordReturn => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordPublic => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordVar => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordVal => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordIf => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
        TokenKind.KeywordWhile => WhitespaceBehavior.PadLeft | WhitespaceBehavior.PadRight,
